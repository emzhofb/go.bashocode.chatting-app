...
| Tinode JS SDK | `0.25.3` (`tinode-sdk`) | <https://github.com/tinode/tinode-js> | pinned in `apps/web/package-lock.json` |
| Tinode web client | reference image `v0.25.3`; custom shell in `apps/web` | <https://github.com/tinode/webapp> | reference client used for acceptance; custom UI bootstrapped with SDK |
